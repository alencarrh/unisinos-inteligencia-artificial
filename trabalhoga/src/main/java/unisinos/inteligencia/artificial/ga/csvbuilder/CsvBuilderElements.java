package unisinos.inteligencia.artificial.ga.csvbuilder;
...
public class CsvBuilderElements<T> {
    ...
    private final Collection<Function<T, Object>> columns;
     ...
     * @return
     */
    public CsvBuilderElements<T> column(Function<T, Object> column) {
